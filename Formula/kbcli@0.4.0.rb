class KbcliAT040 < Formula
  ...
  if OS.mac? && Hardware::CPU.intel?
    url "https://jihulab.com/api/v4/projects/85948/packages/generic/kubeblocks/v0.4.0/kbcli-darwin-amd64-v0.4.0.tar.gz"
    sha256 "c358e28cbc5c9c26904247db4a29419d6ca8e32774e2ea1690a1b267619e76f4"
  end

  if OS.mac? && Hardware::CPU.arm?
    url "https://jihulab.com/api/v4/projects/85948/packages/generic/kubeblocks/v0.4.0/kbcli-darwin-arm64-v0.4.0.tar.gz"
    sha256 "acfff4dcbe2c1886a780ce04b25924582497ea373482d7a6ce50727087b5b317"
  end

  if OS.linux? && Hardware::CPU.intel?
    url "https://jihulab.com/api/v4/projects/85948/packages/generic/kubeblocks/v0.4.0/kbcli-linux-amd64-v0.4.0.tar.gz"
  ...
  if OS.linux? && Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
    url "https://jihulab.com/api/v4/projects/85948/packages/generic/kubeblocks/v0.4.0/kbcli-linux-arm64-v0.4.0.tar.gz"
